...
Section fundamental.
  ...
  Proof.
    ...
    - rfn_bind.
      ...
      dvals v2 v2'; rfn_steps; try by rfn_faulty. rfn_val. iRewrite "H1". iRewrite "H2". rwu. destruct binop; auto.
    ...
    - asimpl. rw_of_val. rfn_val. eauto.
      simpl. rwu. simpl. iNext. iIntros (w w') "Hww'". asimpl.
    ...
    - asimpl. rfn_steps. iApply (rfn_faulty); try by faulty_solver.
      eexists [], _; eauto.
      eexists [], _; eauto.
